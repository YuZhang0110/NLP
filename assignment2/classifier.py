...
class BertSentClassifier(torch.nn.Module):
    def __init__(self, config):
        ...
        # After pooling the output from BERT, we will pass the representation 
        # through a dropout layer and then a linear layer for classification.
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # Pooled output is the representation of the [CLS] token after passing through a tanh activation.
